...
(function () {
  ...
  const fakeScreenXGet = spoofToString(function screenX() {
    return this.clientX + (window.screenX || 0);
  }, origScreenXGet);
  const fakeScreenYGet = spoofToString(function screenY() {
    return this.clientY + (window.screenY || 0) + chromeHeight;
  }, origScreenYGet);
  ...
  if (typeof InputDeviceCapabilities !== "undefined") {
    ...
    const fakeCapGet = spoofToString(function sourceCapabilities() {
      return mouseCaps;
    }, origCapGet);
  ...
  if (typeof PointerEvent !== "undefined") {
    ...
    const fakePressureGet = spoofToString(function pressure() {
      return this.buttons > 0 ? 0.5 : 0;
    }, origPressureGet);
    ...
    const fakeWidthGet = spoofToString(function width() {
      return 1;
    }, origWidthGet);
    ...
    const fakeHeightGet = spoofToString(function height() {
      return 1;
    }, origHeightGet);
