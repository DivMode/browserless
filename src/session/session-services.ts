...
export const TargetRegistryService = ServiceMap.Service<{
  ...
  readonly registerIframe: (iframeTargetId: TargetId, iframeCdpSession: CdpSessionId, parentCdpSession: CdpSessionId) => void;
  readonly getParentCdpSessionForIframe: (iframeCdpSession: CdpSessionId) => CdpSessionId | undefined;
