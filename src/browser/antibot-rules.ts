...
const detectAkamai: DetectorRule = {
  ...
  windows: [{ path: "bmak", expectedType: "object", confidence: 95 }],
};
...
const detectDataDome: DetectorRule = {
  ...
  name: "DataDome",
  category: "antibot",
  cookies: [{ pattern: "^datadome$", isRegex: true, confidence: 100 }],
  headers: [{ pattern: "^x-datadome-cid$", isRegex: true, confidence: 100 }],
};
...
const detectIncapsula: DetectorRule = {
  ...
  windows: [{ path: "_Incapsula", expectedType: "object", confidence: 100 }],
};
...
const detectPerimeterX: DetectorRule = {
  ...
  urls: [{ pattern: "perimeterx.net", confidence: 100 }],
  content: [
...
const detectShapeSecurity: DetectorRule = {
  ...
  urls: [{ pattern: "\\?seed=[A-Za-z0-9_\\-]+", isRegex: true, confidence: 100 }],
  content: [{ pattern: "shapesecurity", confidence: 50 }],
  windows: [{ path: "__xr_bmobdb", expectedType: "function", confidence: 100 }],
};
...
const detectKasada: DetectorRule = {
  ...
  name: "Kasada",
  category: "antibot",
  urls: [{ pattern: "ips.js", confidence: 95 }],
  content: [{ pattern: "kasada", confidence: 50 }],
};
...
const detectSucuri: DetectorRule = {
  ...
  name: "Sucuri WAF",
  category: "antibot",
  content: [{ pattern: "sucuri", confidence: 50 }],
};
...
const detectThreatMetrix: DetectorRule = {
  ...
  name: "ThreatMetrix",
  category: "antibot",
  urls: [{ pattern: "fp/check.js", confidence: 95 }],
  content: [{ pattern: "ThreatMetrix", confidence: 50 }],
  windows: [{ path: "BNQL", expectedType: "object", confidence: 90 }],
};
...
const detectMeetrics: DetectorRule = {
  ...
  name: "Meetrics",
  category: "antibot",
  urls: [{ pattern: "mxcdn.net/bb-mx/serve/mtrcs", confidence: 100 }],
  content: [
    { pattern: "meetricsGlobal", confidence: 50 },
    { pattern: "meetrics", confidence: 50 },
  ],
  windows: [{ path: "meetricsGlobal", expectedType: "object", confidence: 100 }],
};
...
const detectHcaptcha: DetectorRule = {
  ...
  name: "hCaptcha",
  category: "captcha",
  urls: [{ pattern: "hcaptcha.com", confidence: 100 }],
  content: [
  ...
  windows: [{ path: "hcaptcha", expectedType: "object", confidence: 100 }],
};
...
const detectQcloud: DetectorRule = {
  ...
  content: [{ pattern: "TencentCaptcha", confidence: 50 }],
  dom: [
    { selector: "#tencent_captcha", confidence: 95 },
    { selector: "iframe[src*='turing.captcha.qcloud.com']", confidence: 100 },
  ],
  windows: [{ path: "TencentCaptcha", expectedType: "function", confidence: 100 }],
};
...
const detectAliexpress: DetectorRule = {
  ...
  category: "captcha",
  urls: [{ pattern: "punish?x5secdata", confidence: 100 }],
  content: [{ pattern: "x5secdata", confidence: 50 }],
};
...
const detectFriendlyCaptcha: DetectorRule = {
  ...
  category: "captcha",
  urls: [{ pattern: "friendlycaptcha.com", confidence: 100 }],
  content: [
  ...
  windows: [{ path: "friendlyChallenge", expectedType: "object", confidence: 95 }],
};
...
const detectCaptchaEu: DetectorRule = {
  ...
  name: "Captcha.eu",
  category: "captcha",
  urls: [{ pattern: "captcha.eu", confidence: 100 }],
  content: [
  ...
  windows: [{ path: "CaptchaEU", expectedType: "object", confidence: 100 }],
};
...
const detectWebglFingerprint: DetectorRule = {
  ...
  jsHooks: [
    ...
    {
      target: "WebGLRenderingContext.prototype.getSupportedExtensions",
      confidence: 100,
      enabled: true,
    },
...
const detectHardwareFingerprint: DetectorRule = {
  ...
  windows: [{ path: "navigator.maxTouchPoints", expectedType: "number", confidence: 80 }],
};
...
const detectBatteryFingerprint: DetectorRule = {
  ...
  category: "fingerprint",
  jsHooks: [{ target: "Navigator.prototype.getBattery", confidence: 65, enabled: true }],
};
...
const detectMediaFingerprint: DetectorRule = {
  ...
  category: "fingerprint",
  jsHooks: [{ target: "HTMLMediaElement.prototype.canPlayType", confidence: 80, enabled: true }],
  windows: [{ path: "speechSynthesis", expectedType: "object", confidence: 80 }],
};
...
const detectGamepadsFingerprint: DetectorRule = {
  ...
  category: "fingerprint",
  jsHooks: [{ target: "Navigator.prototype.getGamepads", confidence: 80, enabled: true }],
};
...
const detectCssFingerprint: DetectorRule = {
  ...
  windows: [{ path: "CSS.supports", expectedType: "function", confidence: 80 }],
};
