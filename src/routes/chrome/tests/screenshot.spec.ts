...
describe("/chrome/screenshot API", function () {
  ...
  it("404s GET requests", async () => {
    ...
    await fetch("http://localhost:3000/chrome/screenshot?token=browserless").then((res) => {
  ...
  it("times out requests", async () => {
    ...
    await fetch("http://localhost:3000/chrome/screenshot?token=browserless&timeout=10", {
      body: JSON.stringify(body),
      headers: {
        "content-type": "application/json",
      },
